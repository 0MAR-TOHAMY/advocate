...
import {
    Scale, Users, Briefcase, Shield, Save, X, Zap,
    ArrowLeft, ArrowRight, CheckCircle2, Info, Lock,
    ChevronRight, ChevronLeft, Plus, Trash2, Gavel,
    CreditCard, ShieldCheck, FileText, AlertCircle
} from "lucide-react";
...
interface AddCaseWizardProps {
    onClose?: () => void;
}

export default function AddCaseWizard({ onClose }: AddCaseWizardProps) {
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <div className="space-y-3">
                                ...
                                <Select
                                    ...
                                    options={[{ value: "", label: t("selectCase") }, ...casesList.map(c => ({ value: c.id, label: c.title }))]}
                                    className="h-12 border-gray-100 bg-gray-50/20 focus:bg-white rounded-xl shadow-xs transition-all"
                                />
                                {linkedCaseId && (
                    ...
                    <div className="space-y-10 animate-in fade-in slide-in-from-bottom-2 duration-500">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <div className="space-y-3">
                                ...
                                <Input
                                    id="opposingPartyCapacity"
                                    name="opposingPartyCapacity"
                                    value={formData.opposingPartyCapacity}
                                    onChange={handleChange}
                                    className="h-12 border-gray-100 bg-gray-50/20 focus:bg-white rounded-xl shadow-xs transition-all"
                                />
                            </div>
                    ...
                    <div className="space-y-12 animate-in fade-in slide-in-from-bottom-2 duration-500">
                        ...
                        <div className="p-8 rounded-[32px] bg-slate-50/50 border border-slate-100 space-y-8 relative overflow-hidden backdrop-blur-sm">
                            ...
                            <div className="relative z-10">
                                <Label className="block text-[14px] font-black text-gray-500 uppercase tracking-widest mx-2 mb-2">{t("casePassword")}</Label>
                                <Input
                                    id="password"
                                    name="password"
                                    type="password"
                        ...
                        {/* Review Summary Card - High Contrast Premium */}
                            ...
                            <div className="relative z-10 flex flex-col gap-8">
                                <div className="flex items-center justify-between border-b border-white/10 pb-6">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            <h3 className="text-lg font-black uppercase tracking-tight leading-none">{t("common.confirm")}</h3>
    ...
    return (
        <div className="max-w-4xl mx-auto py-8 px-4">
            ...
            <div className="mb-8 flex items-center justify-between">
                <div>
                    <h1 className="text-2xl font-black text-gray-900 tracking-tight leading-tight uppercase">{t("wizard.createNewCase")}</h1>
                    <p className="text-gray-400 text-xs font-medium">{t("wizard.enterCaseDetails")}</p>
                </div>
                <button

...
export default function ClientDocumentUploadDialog({
    open,
    onClose,
    onUpload,
    clientId,
            ...
            >
                <div className="relative">
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        {/* Expiry Date */}
                        <div className="space-y-1.5">
                            <Label className="mx-2 text-[10px] font-black text-gray-400 uppercase tracking-widest">{t("expiryDate")}</Label>
                            <DateTimeInput
                    ...
                    <LoadingModal isOpen={uploading} message={tCommon("loading")} />
                </div>
            </Modal>

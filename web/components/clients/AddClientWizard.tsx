...
export default function AddClientWizard({ onClose }: AddClientWizardProps) {
        ...
        try {
            ...
            if (uploadPromises.length > 0) {
                ...
                if (failedUploads.length > 0) {
                    ...
                    // We don't throw here as the client was already created successfully
                }
            }

            // 3. Success notification
            success(tClients("createSuccess"));
            ...
            error(err.message || tClients("createError"));
        } finally {
            setIsLoading(false);
        }
    };
    ...
    return (
        <div className="max-w-4xl mx-auto py-8 px-4">
            ...
            <div className="mb-8 flex items-center justify-between">
                <div>
                    <h1 className="text-2xl font-black text-gray-900 tracking-tight leading-tight uppercase">{t("createNewClient")}</h1>
                </div>
                <button
                    ...
                    <div className="flex items-center gap-4">
                        {currentStep === steps.length - 1 ? (
                            ...
                            >
                                ...
                                <span className="text-sm uppercase">{t("finish")}</span>
                            </Button>
                        ) : (
                            <Button
                                onClick={nextStep}
                            ...
                            >
                                <span className="text-sm uppercase">{t("nextStep")}</span>
                                {isRtl ?

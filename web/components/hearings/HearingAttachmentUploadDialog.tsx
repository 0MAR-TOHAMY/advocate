...
interface HearingAttachmentUploadDialogProps {
    open: boolean;
    onClose: () => void;
    hearingId: string;
...
export default function HearingAttachmentUploadDialog({
    open,
    onClose,
    hearingId,
    onUploaded,
}: HearingAttachmentUploadDialogProps) {
        ...
        <>
            ...
            >
                <div className="space-y-6">
                    <Label htmlFor="file" className="block text-sm font-bold text-gray-700">{isAr ? "الملف" : "File"}</Label>
                    <FileUpload
                        file={file}
                        onChange={setFile}
                        disabled={uploading}
